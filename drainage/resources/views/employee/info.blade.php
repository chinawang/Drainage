                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="name"
                                           value="{{ $employee['name'] }}" placeholder="" disabled="disabled">
                            ...
                            <div class="form-group{{ $errors->has('job') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="job" type="text" class="form-control" name="job"
                                           value="{{ $employee['job'] }}" placeholder=""
                                           disabled="disabled">
                            ...
                            <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="department" type="text" class="form-control" name="department"
                                           value="{{ $employee['department'] }}" placeholder="" disabled="disabled">
                            ...
                            <div class="form-group{{ $errors->has('cellphone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="cellphone" type="text" class="form-control" name="cellphone"
                                           value="{{ $employee['cellphone'] }}" placeholder="" disabled="disabled">
                            ...
                            <div class="form-group{{ $errors->has('voip') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="voip" type="text" class="form-control" name="voip"
                                           value="{{ $employee['voip'] }}" placeholder="" disabled="disabled">
                            ...
                            <div class="form-group{{ $errors->has('call') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="call" type="text" class="form-control" name="call"
                                           value="{{ $employee['call'] }}" placeholder="" disabled="disabled">
