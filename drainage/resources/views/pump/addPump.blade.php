            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default custom-panel">
                    ...
                    <div class="panel-body custom-panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="/pump/store">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('flux1') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="flux1" value="{{ old('flux1') }}" placeholder="请输入1号泵抽水量"  >
                            ...
                            <div class="form-group{{ $errors->has('flux2') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="flux2" value="{{ old('flux2') }}" placeholder="请输入2号泵抽水量"  >
                            ...
                            <div class="form-group{{ $errors->has('flux3') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="flux3" value="{{ old('flux3') }}" placeholder="请输入3号泵抽水量"  >
                            ...
                            <div class="form-group{{ $errors->has('flux4') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="flux4" value="{{ old('flux4') }}" placeholder="请输入4号泵抽水量"  >
                            ...
                            <div class="form-group{{ $errors->has('flux5') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="flux5" value="{{ old('flux5') }}" placeholder="请输入5号泵抽水量"  >
