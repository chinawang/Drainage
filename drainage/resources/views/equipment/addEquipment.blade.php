                    ...
                    <div class="panel-body custom-panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="/equipment/store">
                            ...
                            <div class="form-group{{ $errors->has('purchase_time') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="datepicker" name="purchase_time" value="{{ old('purchase_time') }}" placeholder="请选择购置时间"  >
                            ...
                            <div class="form-group{{ $errors->has('alteration') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="alteration" value="{{ old('alteration') }}" placeholder="请输入备注一"  >
                            ...
                            <div class="form-group{{ $errors->has('remark2') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="remark2" value="{{ old('remark2') }}" placeholder="请输入备注二"  >
                            ...
                            <div class="form-group{{ $errors->has('remark3') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="remark3" value="{{ old('remark3') }}" placeholder="请输入备注三"  >
