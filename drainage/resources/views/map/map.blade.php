        ...
        AMapUI.loadUI(['overlay/SimpleMarker', 'overlay/SimpleInfoWindow'], function (SimpleMarker, SimpleInfoWindow) {
            ...
            for (var i = 0, len = lngLats.length; i < len; i++) {
                ...
                marker.on('click', function (e) {
                    ...
                    infoWindow.setInfoBody('<div class="row" style="width: 300px;margin: 10px;"><div class="col-md-3 col-md-offset-0"><img src="/img/map/dot_yellow.png" style="width: 32px;height: 32px;margin-left: 10px"></div><div class="col-md-9 col-md-offset-0"><div style="font-size: 14px;color:#4a4a4a">已启动泵组: 3组</div><div style="font-size: 14px;color:#4a4a4a">未启动泵组: 2组</div></div></div>');
