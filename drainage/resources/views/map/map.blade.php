        ...
        AMapUI.loadUI(['overlay/SimpleMarker', 'overlay/SimpleInfoWindow'], function (SimpleMarker, SimpleInfoWindow) {
            ...
            for (var i = 0, len = lngLats.length; i < len; i++) {
                ...
                marker.on('click', function (e) {
                    ...
                    infoWindow.setInfoTitle('<p style="font-size: 20px">金水路泵站</p>');
                    infoWindow.setInfoBody('<div class="row" style="width: 200px"><div class="col-md-2 col-md-offset-0"><img src="/img/map/dot_yellow.png"></div><div class="col-md-10 col-md-offset-0"><div style="font-size: 14px;color:#4a4a4a">已启动泵组: 3组</div><div style="font-size: 14px;color:#4a4a4a">未启动泵组: 2组</div></div></div><');
