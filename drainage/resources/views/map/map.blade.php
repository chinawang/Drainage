...
//                });
                ...
                marker.on('mouseover', function (e) {
                    ...
                    infoWindow.setInfoBody('<div class="row" style="width: 260px;margin: 10px 0;"><div class="col-md-3 col-md-offset-0"><img src="/img/map/dot_yellow.png" style="width: 32px;height: 32px;"></div><div class="col-md-7 col-md-offset-0"><div style="font-size: 14px;color:#4a4a4a">已启动泵组: 3组</div><div style="font-size: 14px;color:#4a4a4a">未启动泵组: 2组</div></div><div class="col-md-2 col-md-offset-0"><a href="/station/lists" class="btn-link" style="font-size: 12px">详情</a></div></div>');
